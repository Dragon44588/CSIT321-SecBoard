...
!(function () {
	...
	const Uo = (e) => (t) => !!t && t.nodeType === e,
		...
		cs = (e, t = 4, n = !0, o = !0) => {
			const r = ((e, t) => (t <= 0 ? "" : new Array(t + 1).join(" ")))(0, t),
				s = e.replace(/\t/g, r),
				a = X(s, (e, t) => (((e) => -1 !== " \f\t\v".indexOf(e))(t) || t === fr ? (e.pcIsSpace || ("" === e.str && n) || (e.str.length === s.length - 1 && o) || ((e, t) => t < e.length && t >= 0 && ds(e[t]))(s, e.str.length + 1) ? { pcIsSpace: !1, str: e.str + fr } : { pcIsSpace: !0, str: e.str + " " }) : { pcIsSpace: ds(t), str: e.str + t }), { pcIsSpace: !1, str: "" });
			return a.str;
		},
		us = (e, t) =>
			(os(e) &&
	...
	const ps = (e, t = !0) =>
			...
			const o = {},
				...
				a = (e) =>
					new Promise((a, i) => {
						...
						var p;
						Jt(g, { rel: "stylesheet", type: "text/css", id: c.id }), t.contentCssCors && Qt(g, "crossOrigin", "anonymous"), t.referrerPolicy && Qt(g, "referrerpolicy", t.referrerPolicy), (l = g.dom), (l.onload = m), (l.onerror = f), (p = g), ho(Vn(r), p), Qt(g, "href", d);
					}),
				i = (e) => {
		...
		js = /[<>&\"\']/g,
		Hs = /&#([a-z0-9]+);?|&([a-z0-9]+);/gi,
		$s = { 128: "\u20ac", 130: "\u201a", 131: "\u0192", 132: "\u201e", 133: "\u2026", 134: "\u2020", 135: "\u2021", 136: "\u02c6", 137: "\u2030", 138: "\u0160", 139: "\u2039", 140: "\u0152", 142: "\u017d", 145: "\u2018", 146: "\u2019", 147: "\u201c", 148: "\u201d", 149: "\u2022", 150: "\u2013", 151: "\u2014", 152: "\u02dc", 153: "\u2122", 154: "\u0161", 155: "\u203a", 156: "\u0153", 158: "\u017e", 159: "\u0178" },
		Vs = { '"': "&quot;", "'": "&#39;", "<": "&lt;", ">": "&gt;", "&": "&amp;", "`": "&#96;" },
		qs = { "&lt;": "<", "&gt;": ">", "&amp;": "&", "&quot;": '"', "&apos;": "'" },
		Ws = (e, t) => {
			const n = {};
			...
			const s = {},
				...
				d = ((e) => {
					...
					return (
						...
						a("noscript", "", s),
						"html4" !== e && (a("wbr"), a("ruby", "", [r, "rt rp"].join(" ")), a("figcaption", "", s), a("mark rt rp summary bdi", "", r), a("canvas", "width height", s), a("video", "src crossorigin poster preload autoplay mediagroup loop muted controls width height buffered", [s, "track source"].join(" ")), a("audio", "src crossorigin preload autoplay mediagroup loop muted controls buffered volume", [s, "track source"].join(" ")), a("picture", "", "img source"), a("source", "src srcset type media sizes"), a("track", "kind src srclang label default"), a("datalist", "", [r, "option"].join(" ")), a("article section nav aside main header footer", "", s), a("hgroup", "", "h1 h2 h3 h4 h5 h6"), a("figure", "", [s, "figcaption"].join(" ")), a("time", "datetime", r), a("dialog", "open", s), a("command", "type label icon disabled checked radiogroup command"), a("output", "for form name", r), a("progress", "value max", r), a("meter", "value min max low high optimum", r), a("details", "open", [s, "summary"].join(" ")), a("keygen", "autofocus challenge disabled form keytype name")),
						"html5-strict" !== e &&
				...
				"DOMContentLoaded" === t && (t = "ready"),
					r.domLoaded && "ready" === t && "complete" === e.readyState
						...
						: (r.hasFocusIn ||
						  ...
						  (s = r.events[l][t]),
						  s ? ("ready" === t && r.domLoaded ? n(va({ type: t })) : s.push({ func: n, scope: o })) : ((r.events[l][t] = s = [{ func: n, scope: o }]), (s.fakeName = f), (s.capture = m), (s.nativeHandler = u), "ready" === t ? ya(e, u, r) : ha(e, f || t, u, m)));
			}
			return (e = s = null), n;
		}
		unbind(e, t, n) {
	...
	const Ii = (e, t) => {
		...
		sl = (e) => {
			const t = () => n,
				n = { tag: !1, inner: e, fold: (t, n) => t(e), isValue: L, isError: M, map: t, mapError: (t) => al.error(t(e)), bind: t, exists: L, forall: M, getOr: R, or: R, getOrThunk: D, orThunk: D, getOrDie: B(String(e)), each: E, toOptional: I.none };
			return n;
		},
				...
				u = (t) => {
					switch (
						((e, t, n, o) =>
							Rn(t).fold(
								() => "skipping",
								(r) => ("br" === o || ((e) => Wt(e) && hr(e) === Pr)(t) ? "valid" : ((e) => qt(e) && fn(e, $a()))(t) ? "existing" : ku(t.dom) ? "caret" : $(Hm, (e) => wn(t, e)) ? "valid-block" : mm(e, n, o) && mm(e, jt(r), n) ? "valid" : "invalid-child")
							))(e, t, "span", jt(t))
					) {
						case "invalid-child": {
							d();
	...
	const Gm = (e, t, n) => !n.collapsed && $(n.getClientRects(), (n) => ((e, t, n) => t >= e.left && t <= e.right && n >= e.top && n <= e.bottom)(n, e, t)),
		...
		tf = { BACKSPACE: 8, DELETE: 46, DOWN: 40, ENTER: 13, ESC: 27, LEFT: 37, RIGHT: 39, SPACEBAR: 32, TAB: 9, UP: 38, PAGE_UP: 33, PAGE_DOWN: 34, END: 35, HOME: 36, modifierPressed: (e) => e.shiftKey || e.ctrlKey || e.altKey || tf.metaKeyPressed(e), metaKeyPressed: (e) => (At.os.isMacOS() || At.os.isiOS() ? e.metaKey : e.ctrlKey && !e.altKey) },
	...
	const mf = (e, t, n, o) => ({ start: e, soffset: t, finish: n, foffset: o }),
		...
		xf = (e) => {
			...
			return ((e, t) => {
				const n = ((e, t) => t.match({ domRange: (e) => ({ ltr: N(e), rtl: I.none }), relative: (t, n) => ({ ltr: Pe(() => lf(e, t, n)), rtl: Pe(() => I.some(lf(e, n, t))) }), exact: (t, n, o, r) => ({ ltr: Pe(() => df(e, t, n, o, r)), rtl: Pe(() => I.some(df(e, o, r, t, n))) }) }))(e, t);
				return ((e, t) => {
					const n = t.ltr();
					return n.collapsed
						? t
		...
		My = (function e() {
			...
			var T,
				...
				xe = function (e) {
					(ye && ye === e) ||
						...
						X && (G = !1),
						te && (ee = !0),
						ae && ((z = fy({}, Hv(xy))), (H = []), !0 === ae.html && (fy(z, hy), fy(H, ky)), !0 === ae.svg && (fy(z, by), fy(H, Ey), fy(H, _y)), !0 === ae.svgFilters && (fy(z, vy), fy(H, Ey), fy(H, _y)), !0 === ae.mathMl && (fy(z, Cy), fy(H, Sy), fy(H, _y))),
			...
			var Re = function (e) {
				...
				Pe = function (e) {
					...
					var r = B(e.nodeName);
					if ((De("uponSanitizeElement", e, { tagName: r, allowedTags: z }), e.hasChildNodes() && !Be(e.firstElementChild) && (!Be(e.content) || !Be(e.content.firstElementChild)) && cy(/<[/\w]/g, e.innerHTML) && cy(/<[/\w]/g, e.textContent))) return Re(e), !0;
					...
					return e instanceof l &&
						...
						? (X && 3 === e.nodeType && ((t = e.textContent), (t = iy(t, D, " ")), (t = iy(t, P, " ")), e.textContent !== t && (ry(n.removed, { element: e.cloneNode() }), (e.textContent = t))), De("afterSanitizeElements", e, null), !1)
						: (Re(e), !0);
				},
				Le = function (e, t, n) {
						...
						})(e, t, n, o, r, s),
						{
							unbind: () =>
								((e, t, n) => {
									...
									q(t.split(","), (e) =>
										xe(o, e).each((t) => {
											o[e] = { withSimilar: { ...t.withSimilar, callbacks: G(t.withSimilar.callbacks, (e) => e !== n) }, withoutSimilar: { ...t.withoutSimilar, callbacks: G(t.withoutSimilar.callbacks, (e) => e !== n) }, withVars: G(t.withVars, (e) => e.callback !== n) };
										})
									),
										e.set(o);
								})(t, n, o),
	...
	const Rw = (e, t) => {
		...
		Pw = { tablecellbackgroundcolor: { styles: { backgroundColor: "%value" }, ...Dw }, tablecellverticalalign: { styles: { "vertical-align": "%value" }, ...Dw }, tablecellbordercolor: { styles: { borderColor: "%value" }, ...Dw }, tablecellclass: { classes: ["%value"], ...Dw }, tableclass: { selector: "table", classes: ["%value"], ...Bw }, tablecellborderstyle: { styles: { borderStyle: "%value" }, ...Dw }, tablecellborderwidth: { styles: { borderWidth: "%value" }, ...Dw } },
		Lw = N(Pw),
		Mw = Dt.each,
		Iw = Oa.DOM,
		Fw = (e) => C(e) && f(e),
							...
							return !t && gp(r)
								...
								: ((e, t, n) =>
										((e, t) => {
											...
											? ((e, t) => (y(t) ? I.none() : e && sr(t.nextSibling) ? I.some(vx.moveToElement(t.nextSibling)) : !e && sr(t.previousSibling) ? I.some(vx.moveToElement(t.previousSibling)) : I.none()))(t, n.getNode(!t)).orThunk(() => yx(e, t, n))
											: yx(e, t, n).bind((t) =>
													((e, t, n) =>
														n.fold(
						...
						create: () =>
							((e, t) => {
								const { dom: n, selection: o } = e,
									r = e.getBody();
								t.set(o.getRng());
								const s = n.add(e.getBody(), "div", { id: "mcepastebin", class: "mce-pastebin", contentEditable: !0, "data-mce-bogus": "all", style: "position: fixed; top: 50%; width: 10px; height: 10px; overflow: hidden; opacity: 0" }, iR);
	...
	const sA = (e, t) => Math.abs(e.left - t),
		...
		fA = (e, t, n, o) => {
			...
			return v(o)
				? ((e, t, n) => {
						...
						return { bubbles: !0, cancelBubble: !1, cancelable: !0, composed: !1, currentTarget: null, defaultPrevented: !1, eventPhase: 0, isTrusted: !0, returnValue: !1, timeStamp: 0, type: e, composedPath: o, initEvent: o, preventDefault: E, stopImmediatePropagation: E, stopPropagation: E, AT_TARGET: window.Event.AT_TARGET, BUBBLING_PHASE: window.Event.BUBBLING_PHASE, CAPTURING_PHASE: window.Event.CAPTURING_PHASE, NONE: window.Event.NONE, altKey: !1, button: 0, buttons: 0, clientX: 0, clientY: 0, ctrlKey: !1, metaKey: !1, movementX: 0, movementY: 0, offsetX: 0, offsetY: 0, pageX: 0, pageY: 0, relatedTarget: null, screenX: 0, screenY: 0, shiftKey: !1, x: 0, y: 0, detail: 0, view: null, which: 0, initUIEvent: o, initMouseEvent: o, getModifierState: o, dataTransfer: n, ...mA(t) };
				  })(e, t, r)
		...
		sO = (e) => {
			...
			return rO({ allow_conditional_comments: t("allow_conditional_comments"), allow_html_data_urls: t("allow_html_data_urls"), allow_svg_data_urls: t("allow_svg_data_urls"), allow_html_in_named_anchor: t("allow_html_in_named_anchor"), allow_script_urls: t("allow_script_urls"), allow_unsafe_link_target: t("allow_unsafe_link_target"), convert_fonts_to_spans: t("convert_fonts_to_spans"), fix_list_elements: t("fix_list_elements"), font_size_legacy_values: t("font_size_legacy_values"), forced_root_block: t("forced_root_block"), forced_root_block_attrs: t("forced_root_block_attrs"), preserve_cdata: t("preserve_cdata"), inline_styles: t("inline_styles"), root_name: oO(e), sanitize: t("xss_sanitization"), validate: !0, blob_cache: n, document: e.getDoc() });
		},
		aO = (e) => {
			const t = e.options.get;
			return rO({ custom_elements: t("custom_elements"), extended_valid_elements: t("extended_valid_elements"), invalid_elements: t("invalid_elements"), invalid_styles: t("invalid_styles"), schema: t("schema"), valid_children: t("valid_children"), valid_classes: t("valid_classes"), valid_elements: t("valid_elements"), valid_styles: t("valid_styles"), verify_html: t("verify_html"), padd_empty_block_inline_children: t("format_empty_lines") });
		},
		...
		cO = (e) => {
			...
			(o.disabled = !0),
				...
				(e.serializer = WC(
					((e) => {
						const t = e.options.get;
						return { ...sO(e), ...aO(e), ...rO({ remove_trailing_brs: t("remove_trailing_brs"), pad_empty_with_br: t("pad_empty_with_br"), url_converter: t("url_converter"), url_converter_scope: t("url_converter_scope"), element_format: t("element_format"), entities: t("entities"), entity_encoding: t("entity_encoding"), indent: t("indent"), indent_after: t("indent_after"), indent_before: t("indent_before") }) };
					})(e),
					e
				)),
				...
				return ((e) => xe(e.plugins, "rtc").bind((e) => I.from(e.setup)))(e).fold(
					...
					(e) => (
						(t.rtcInstance = (() => {
							const e = N(null),
								t = N("");
							return { init: { bindEvents: E }, undoManager: { beforeChange: E, add: e, undo: e, redo: e, clear: E, reset: E, hasUndo: L, hasRedo: L, transact: e, ignore: E, extra: E }, formatter: { match: L, matchAll: N([]), matchNode: N(void 0), canApply: L, closest: t, apply: E, remove: E, toggle: E, formatChanged: N({ unbind: E }) }, editor: { getContent: t, setContent: N({ content: "", html: "" }), insertContent: N(""), addVisual: E }, selection: { getContent: t }, autocompleter: { addDecoration: E, removeDecoration: E }, raw: { getModel: N(I.none()) } };
						})()),
						I.some(() =>
							e().then(
								(e) => (
	...
	const wT = () => {
			const e = (() => {
				...
				return { addButton: l(e, "button"), addGroupToolbarButton: l(e, "grouptoolbarbutton"), addToggleButton: l(e, "togglebutton"), addMenuButton: l(e, "menubutton"), addSplitButton: l(e, "splitbutton"), addMenuItem: l(t, "menuitem"), addNestedMenuItem: l(t, "nestedmenuitem"), addToggleMenuItem: l(t, "togglemenuitem"), addAutocompleter: l(n, "autocompleter"), addContextMenu: l(r, "contextmenu"), addContextToolbar: l(s, "contexttoolbar"), addContextForm: l(s, "contextform"), addSidebar: l(a, "sidebar"), addView: l(i, "views"), addIcon: (e, t) => (o[e.toLowerCase()] = t), getAll: () => ({ buttons: e, menuItems: t, icons: o, popups: n, contextMenus: r, contextToolbars: s, sidebars: a, views: i }) };
			})();
					...
					t("id", { processor: "string", default: e.id }),
						...
						t("content_css", {
							processor: (e) => {
								...
								return t ? (m(e) ? { value: V(e.split(","), qe), valid: t } : p(e) ? { value: e, valid: t } : !1 === e ? { value: [], valid: t } : { value: e, valid: t }) : { valid: !1, message: "Must be false, a string or an array of strings." };
							},
						...
						t("object_resizing", {
							processor: (e) => {
								const t = b(e) || m(e);
								return t ? (!1 === e || gl.isiPhone() || gl.isiPad() ? { value: "", valid: t } : { value: !0 === e ? "table,img,figure.image,div,video,iframe" : e, valid: t }) : { valid: !1, message: "Must be boolean or a string" };
							},
							default: !pl,
						}),
